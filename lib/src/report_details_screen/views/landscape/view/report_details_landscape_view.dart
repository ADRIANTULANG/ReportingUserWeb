...
import '../widget/report_details_landscape_alertdialog.dart';

class ReportDetailsLandscapePage extends GetView<ReportDetailsController> {
  const ReportDetailsLandscapePage({super.key});
                                ...
                                : controller.reportDetails!.remarks.isEmpty
                                    ? SizedBox(
                                        ...
                                        child: ElevatedButton(
                                            onPressed: () {
                                              ReportDetailsLandscapeAlertDialog
